...
const academicsService = {
  ...
  // Library — the Catalogue/Issues/Reservations/Overdue/Reports/Settings
  // functions have moved to src/pages/academics/library/api.ts (the new
  // Library module). getLibraryStats and getOverdueIssues stay here because
  // AcademicsDashboardTab (outside the Library tab) still reads them for its
  // KPI row.
